...
if __name__ == "__main__":
    ...
    for options in planner_options:
        ...
        ego_model_params.maximum_lateral_acc = 12
        ...
        animation_parameter.plot_safety_circles = [0, 1, 2, 3]
        ...
        road_options.random_road_parameters.maximum_kappa = 1 / 30
        ...
        vehicle_planner_opp_2 = VehiclePlannerAcados20222(ego_model_params=opp_model_params_1,
                                                          road=road,
                                                          planner_options=opp_planner_options,
                                                          opp_model_params=[ego_model_params, opp_model_params_0,
                                                                            opp_model_params_1])
        ...
        initial_state_opp_2_f = np.array([ini_dist + 2 * dist + 20, -n_pos, 0.0, speed_opp, 0])

        # Default actions
        action0 = np.array([0., 50., 1e2])
        action1 = np.array([-n_pos, speed_opp, 1e5])
        action2 = np.array([n_pos, speed_opp, 1e5])
        action3 = np.array([-n_pos, speed_opp, 1e5])
        ...
        simulator = SimpleSimulator(options=simulator_options,
                                    ...
                                    planners=[vehicle_planner_ego, vehicle_planner_opp_0, vehicle_planner_opp_1,
                                              vehicle_planner_opp_2],
                                    road=road,
                                    default_actions=[action0, action1, action2, action3])
    ...
    print(t)
    with open("save_data_short_add_safe", "wb") as fp:  # Pickling
